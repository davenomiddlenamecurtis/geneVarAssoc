...
int main(int argc,char *argv[])
{
	...
	fprintf(fo,"COMPARISON_SITE_ID\tDIFF_PATTERN\tChr\tStart\tEnd\tRefAllele\tVariant\tRarestVariant\tMinFrequency\tCallConfidence\tCallPassedFilter\tCallChiprOverridden\tGeneSummary\tGenePhenSummary\tMinDistance\tMaxDistance\tGreatestEffect\tConservationScore\n");
	...
	while (*geneStr='\0',fgets(line,20000,fp))
	{
		...
		do {
			switch (f)
			{
			case 1: sscanf(ptr," '%s '",dpStr); break;
			case 2: sscanf(ptr," %s",chrStr); break;
			case 3: sscanf(ptr," %s",stStr); break;
			case 4: sscanf(ptr," %s",enStr); break;
			case 5: sscanf(ptr," %s",refStr); break;
