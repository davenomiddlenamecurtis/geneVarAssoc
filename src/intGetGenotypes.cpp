...
extern int outputGenotypes(FILE *fo, masterLocusFile *vf, analysisSpecs spec);

int main(int argc,char *argv[])
{
	geneExtractor gcase,gcont;
	refseqGeneInfo r;
	char fn[100],fn2[100],line[1000],geneName[100],intName[100];
	int i,first;
	FILE *fp,*fg,*fo;
	gvaParams gp;
	analysisSpecs spec;
